...
### MLB Betting.
##################################################
pdf('writing/mlb_bets_by_season.pdf', width = 18, height = 13)
par(mfrow = c(3,2))
...
pdf('writing/Party_by_Team_Location.pdf', width = 18, height = 12)
...
pdf('writing/travel_dist_density_by_party.pdf', width = 15, height = 13)
...
pdf('writing/next_day_opponent_on_tour.pdf', width = 16, height = 12)
...
pdf('writing/why_drinks_or_population_dont_work.pdf', width = 16, height = 12)
ticks = 1:nrow(tmp)
plot(x = ticks,
...
pdf('writing/distribution_point_spreads_nba.pdf', width = 19, height = 13)
