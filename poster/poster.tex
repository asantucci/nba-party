...
\block{Model}{
  ...
  \]
  Our setup relies on a quasi-experiment: we look for instances where a team plays in a city
  with active nightlife, then plays a game in a different location the next day. Since next-day
