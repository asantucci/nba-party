...
There are numerous reports of professional sports teams partying on 
...
most notorious for pursuing active nightlife in the NBA.\cite{chase} The study
 concludes that players perform worse on Sundays when compared with other days, as measured by the ratio of shots scored to shots taken.
...
to erase home field advantage in major league baseball.\cite{songetal}
...
We consider games which have been played at most 24 hours ago, and take care to ignore
...
Los Angeles or New York within 24 hours of their current game, we indicate one, else zero. 
...
sport. To that end, we look toward
