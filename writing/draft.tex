...
particularly musicians. This motivated a continuous measure of nightlife, based on a simple count of the number of musicians in the county in which the stadium resides: if the last game was played at most 24-hours ago, use the log of the total number
...
are for a particular county-year: we simply calculate the total number of establishments across all three music categories listed above. We caveat that since the Toronto Raptors are located in Canada, we don't have BLS data for this team.\footnote{We don't expect this to be a party city.}
...
\begin{tabular}{@{\extracolsep{5pt}}lcc}  \\[-1.8ex]\hline  \hline \\[-1.8ex]   & \multicolumn{2}{c}{\textit{Dependent variable:}} \\  \cline{2-3}  \\[-1.8ex] & \multicolumn{2}{c}{Meet the Spread} \\  \\[-1.8ex] & (1) & (2)\\  \hline \\[-1.8ex]   Party discrete & $-$0.513$^{***}$ &  \\    & (0.145) &  \\    & & \\   Party continuous &  & $-$0.199$^{**}$ \\    &  & (0.100) \\    & & \\   Lag changes in posession & 0.0001 & 0.00004 \\    & (0.002) & (0.002) \\    & & \\   Logged travel distance & $-$0.017 & $-$0.014 \\    & (0.026) & (0.026) \\    & & \\   East-west travel direction & $-$0.146 & $-$0.112 \\    & (0.231) & (0.231) \\    & & \\   Number hours rest time & 0.001 & 0.001 \\    & (0.001) & (0.001) \\    & & \\   Time of game during day & 0.005 & 0.004 \\    & (0.013) & (0.013) \\    & & \\   Home team effect & 0.001 & 0.003 \\    & (0.043) & (0.043) \\    & & \\   Logged travel distance * east-west & 0.022 & 0.017 \\    & (0.036) & (0.036) \\    & & \\   Constant & $-$0.048 & $-$0.034 \\    & (0.378) & (0.378) \\    & & \\  \hline \\[-1.8ex]  Observations & 9,823 & 9,823 \\  Log Likelihood & $-$6,800.675 & $-$6,805.106 \\  Akaike Inf. Crit. & 13,619.350 & 13,628.210 \\  \hline  \hline \\[-1.8ex]  \textit{Note:}  & \multicolumn{2}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\  \end{tabular}  
...
\begin{tabular}{@{\extracolsep{5pt}}lcc}  \\[-1.8ex]\hline  \hline \\[-1.8ex]   & \multicolumn{2}{c}{\textit{Dependent variable:}} \\  \cline{2-3}  \\[-1.8ex] & \multicolumn{2}{c}{Probability of Winning} \\  \\[-1.8ex] & (1) & (2)\\  \hline \\[-1.8ex]   Continuous measure of nightlife & $-$0.142$^{*}$ &  \\    & (0.083) &  \\    & & \\   Nightlife (no weekend interaction) &  & 0.004 \\    &  & (0.107) \\    & & \\   Bookmaker's odds & 2.600$^{***}$ & 2.604$^{***}$ \\    & (0.162) & (0.163) \\    & & \\   Home-team effect & 0.024 & 0.052 \\    & (0.035) & (0.072) \\    & & \\   Number of rest days & 0.015 & 0.015 \\    & (0.019) & (0.020) \\    & & \\   Logged travel distance & $-$0.001 & $-$0.001 \\    & (0.005) & (0.005) \\    & & \\   Weekend & 0.042 & 0.0004 \\    & (0.037) & (0.030) \\    & & \\   Constant & $-$1.329$^{***}$ & $-$1.348$^{***}$ \\    & (0.080) & (0.102) \\    & & \\  \hline \\[-1.8ex]  Observations & 25,215 & 24,781 \\  Log Likelihood & $-$17,274.540 & $-$16,977.790 \\  Akaike Inf. Crit. & 34,563.090 & 33,969.580 \\  \hline  \hline \\[-1.8ex]  \textit{Note:}  & \multicolumn{2}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\  \end{tabular}  
...
by visitation to cities with active nightlife. The same is true in the MLB.

\begin{tabular}{@{\extracolsep{5pt}}lc}  \\[-1.8ex]\hline  \hline \\[-1.8ex]   & \multicolumn{1}{c}{\textit{Dependent variable:}} \\  \cline{2-2}  \\[-1.8ex] & Meet the Spread (NBA) \\  \hline \\[-1.8ex]   party placebo & 0.072 \\    & (0.082) \\    & \\   lag changes in posession & 0.00001 \\    & (0.002) \\    & \\   logged travel distance & $-$0.005 \\    & (0.026) \\    & \\   east-west travel direction & $-$0.100 \\    & (0.232) \\    & \\   number hours rest time & 0.001$^{*}$ \\    & (0.001) \\    & \\   time of game during day & 0.001 \\    & (0.013) \\    & \\   home team effect & $-$0.009 \\    & (0.043) \\    & \\   logged travel distance * east-west & 0.015 \\    & (0.036) \\    & \\   Constant & $-$0.070 \\    & (0.378) \\    & \\  \hline \\[-1.8ex]  Observations & 9,823 \\  Log Likelihood & $-$6,806.701 \\  Akaike Inf. Crit. & 13,631.400 \\  \hline  \hline \\[-1.8ex]  \textit{Note:}  & \multicolumn{1}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\  \end{tabular}

\begin{tabular}{@{\extracolsep{5pt}}lc}  \\[-1.8ex]\hline  \hline \\[-1.8ex]   & \multicolumn{1}{c}{\textit{Dependent variable:}} \\  \cline{2-2}  \\[-1.8ex] & Probability of Winning (MLB) \\  \hline \\[-1.8ex]   Party placebo & 0.004 \\    & (0.107) \\    & \\   Bookmaker's odds & 2.604$^{***}$ \\    & (0.163) \\    & \\   Home-team effect & 0.052 \\    & (0.072) \\    & \\   Number of rest days & 0.015 \\    & (0.020) \\    & \\   Logged travel distance & $-$0.001 \\    & (0.005) \\    & \\   Weekend & 0.0004 \\    & (0.030) \\    & \\   Constant & $-$1.348$^{***}$ \\    & (0.102) \\    & \\  \hline \\[-1.8ex]  Observations & 24,781 \\  Log Likelihood & $-$16,977.790 \\  Akaike Inf. Crit. & 33,969.580 \\  \hline  \hline \\[-1.8ex]  \textit{Note:}  & \multicolumn{1}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\  \end{tabular}  
