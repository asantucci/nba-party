...
% mpa1, tpa, tpo
\hspace{-125pt}
\begin{tabular}{@{\extracolsep{5pt}}lccc}  \\[-1.8ex]\hline  \hline \\[-1.8ex]   & \multicolumn{3}{c}{\textit{Dependent variable:}} \\  \cline{2-4}  \\[-1.8ex] & Team Points Admitted & Team Points Admitted & Team Points Scored \\  \\[-1.8ex] & (1) & (2) & (3)\\  \hline \\[-1.8ex]   Discrete party indicator & 2.649$^{***}$ &  &  \\    & (0.718) &  &  \\    & & & \\   Continuous party measure &  & 1.833$^{***}$ & 0.447$^{*}$ \\    &  & (0.246) & (0.245) \\    & & & \\   Lag change in possessions & 1.058$^{*}$ & 0.022$^{***}$ & 0.035$^{***}$ \\    & (0.615) & (0.007) & (0.007) \\    & & & \\   Logged travel distance & $-$0.045 & $-$0.028 & $-$0.213$^{***}$ \\    & (0.038) & (0.074) & (0.074) \\    & & & \\   Number hours since last game & 0.009$^{**}$ & 0.015$^{***}$ & 0.018$^{***}$ \\    & (0.004) & (0.003) & (0.003) \\    & & & \\   Home team effect & $-$2.997$^{***}$ & $-$3.412$^{***}$ & 2.211$^{***}$ \\    & (0.218) & (0.116) & (0.116) \\    & & & \\   Constant & $-$3.429 & 101.941$^{***}$ & 100.112$^{***}$ \\    & (2.926) & (0.479) & (0.477) \\    & & & \\  \hline \\[-1.8ex]  Observations & 14,843 & 44,689 & 44,689 \\  R$^{2}$ & 0.018 & 0.021 & 0.010 \\  Adjusted R$^{2}$ & 0.017 & 0.021 & 0.010 \\  Residual Std. Error & 11.070 (df = 14831) & 12.002 (df = 44683) & 11.967 (df = 44683) \\  F Statistic & 24.021$^{***}$ (df = 11; 14831) & 196.086$^{***}$ (df = 5; 44683) & 92.809$^{***}$ (df = 5; 44683) \\  \hline  \hline \\[-1.8ex]  \textit{Note:}  & \multicolumn{3}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\  \end{tabular}    
