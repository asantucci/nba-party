...
\begin{frame}   \frametitle{What is the problem?}
  \begin{block}{Do pro athletes party to the detriment of their performance?}
    ...
    \begin{itemize}       
      \item Can we even measure a hangover effect?
...
\begin{frame}   
  \frametitle{Whether players actually party is a latent variable}
  \begin{block}{We can't observe whether players party.}
    Instead, we will consider a quasi-experiment where players are exposed to nightlife. 
