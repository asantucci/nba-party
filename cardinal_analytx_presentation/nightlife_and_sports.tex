...
\begin{frame}
  \centering   \includegraphics[scale=0.55]{meet_the_spread} 
\end{frame}
...
\begin{frame}   \frametitle{A closer look at NBA games on the road}
  \centering \includegraphics[scale=0.25]{next_day_opponent_on_tour} 
\end{frame}
...
\begin{frame}   
  ...
  \centering \includegraphics[scale=0.25]{travel_dist_density_by_party} 
\end{frame}
...
\begin{frame}   
  ...
  \hspace*{-25pt}
  \includegraphics[scale=0.275]{Party_by_Team_Location} 
\end{frame}
...
\begin{frame}   \frametitle{Betting in MLB}
  \centering
  \includegraphics[scale=0.25]{mlb_bets_by_season} \end{frame}
...
\begin{frame}
  \centering
  \includegraphics[scale=0.25]{distribution_point_spreads_nba}
\end{frame}
...
\begin{frame}   
  ...
  \includegraphics[scale=0.25]{why_drinks_or_population_dont_work} \end{frame}
