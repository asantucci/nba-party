...
\author{Andreas Santucci} \institute{Stanford Teaching Fellow \\ Computational Math, Data Science} \title{Effects of nightlife on sports} \subtitle{Cardinal Analytx Interview} % \titlegraphic{\includegraphics[width=2cm]{ctanlion}}
