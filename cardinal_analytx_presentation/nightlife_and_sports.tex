...
\begin{frame}   \frametitle{Is the problem hard?}
  ...
  \begin{block}{Previous research}
    Players under-perform proportion of shots made on Sundays.\footnote{Chase ('15): 1,092 NBA players under-perform relative to their own season-long average out of 2,035 who took at least one shot on Sunday.}

    Teams under-perform bookmakers expectations on Sunday afternoons when on the road.\footnote{Ezekowitz, ('14): Only 129 out of 284 games did the away team meet the spread, using 2008-14 data.}   \end{block}
...
\begin{frame}
  \frametitle{How can we measure unexpected changes in performance?}     \begin{block}{Bookmaker spreads}     
  ...
  \end{block}
  \begin{block}{Bookmaker money-lines}     The odds that a team will beat their opponent.
